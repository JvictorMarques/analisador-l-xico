...
public class Parser {
	...
	private void command() throws Exception {
		...
		switch (token.getType()) {
			...
			case IDENTIFIER:
				...
				break;
			default:
				throw new SyntacticException("Unexpected command: " + token.getType() + "(" + token.getText() + ")");
		}
	}
	...
	private void factor() throws Exception {
		if (token == null) {
			throw new SyntacticException("Unexpected end of file");
		}
		...
		if (token.getType() == TokenType.IDENTIFIER ||
			...
			throw new SyntacticException("Expected identifier, number or '(', found " + 
